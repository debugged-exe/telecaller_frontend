...
import InfoComponentEnglish from "./Components/InfoComponent/InfoComponentEnglish";
...
class App extends Component {
    ...
    render() {
        ...
        return (
            <HashRouter>
                <Switch>
                    ...
                    <Route exact path="/about-course">
                        <InfoComponent/>
                    </Route>
                    <Route exact path="/basic-course">
                        <InfoComponentEnglish/>
                    </Route>
        ...
        //                 <InfoComponentFooter onRouteChange={this.onRouteChange}/>
        //     		</div>
        // 		);
        // 	}
        // 	else if(route==='form')
