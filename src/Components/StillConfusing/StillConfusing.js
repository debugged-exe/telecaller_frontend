    ...
    return (
        <section className={'mr-auto bg-dark-blue pv6-ns tl'}>
            <div className={'pv5 pb5 w-70-ns ml-auto-ns mr-auto-ns white scroll-none-x'}>
                <div className={'pl3'}>
                    <p data-aos="fade-left" data-aos-duration={"1000"} className={'pt1 mb0-ns downmove scroll-none-x'}>START LEARNING WITH US</p>
                    <h1 data-aos="fade-left"  data-aos-duration={"1000"} className={'f1-ns scroll-none-x'}>Still <span className={'red'}>Confused ?</span></h1>
                </div>
                <div className={'w-60-ns pl3 pr3 mr2 scroll-none-x'}>
                    <p data-aos="fade-left" data-aos-delay="100" data-aos-duration="1500" className={'scroll-none-x w-80-ns pb3-ns f4-ns'}>We understand your problems. You may have many questions boiling up in your mind. To address your
