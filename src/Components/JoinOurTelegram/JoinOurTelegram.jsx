    ...
    return (
        <section className={'mr-auto bg-white pv6-ns tl'}>
            <div className={'pv5 pb5 w-70-ns ml-auto-ns mr-auto-ns white'}>
                <div data-aos="fade-right" data-aos-duration="1000"className={'pl3'}>
                    <h1 className={'f1-ns black'}>Join Our <span className={'red'}>Telegram Community!</span></h1>
                </div>
                <div className={'w-60-ns pl3 pr3 mr2'}>
                    <p data-aos="fade-right" data-aos-duration="1000" data-aos-delay="100" className={'w-80-ns pb3-ns f4-ns black'}>We understand your problems. You may have many questions boiling up in your mind. To address your
                        concerns we recommend you sign up for a Premium consultation with us.</p>
                      <a data-aos="fade-up" data-aos-duration={"1000"} data-aos-delay={"200"} className="no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center ma2 tc br2 pa2"
