                    ...
                    <article className="w-70-ns  shadow-2 center br3 pa3 pa4-ns mv3 ">
                        <div className={'flex flex-wrap justify-center'}>
                            <div className="">
                                ...
                                <a style={{ outline: 'none' }} data-aos={"fade-up"} data-aos-delay={"250"} className="f5 link dim br1 ph3 pv2 mb2 dib white bg-red br2 b" href="https://surveyheart.com/form/608f89d91ff2fc715c435b07" >Session Joining Form</a>
                            </div>
                        </div>
                    </article>
                </div>
