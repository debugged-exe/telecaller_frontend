...
export default function OpenAccount() {
    return (
        <section className={'mr-auto w-100 bg-black white tl'}>
            <div className={'pv5 pb5 w-80-ns ml-auto-ns mr-auto-ns scroll-none-x'}>
                <div data-aos={"fade-left"} data-aos-duration={"1000"} className={'scroll-none-x'}>
                    <div className={''}>
                    ...
                    <article className="w-50-ns w-70-m shadow-2 center br3 pa3 pa4-ns mv3 ">
                        <div className={'flex flex-wrap justify-center'}>
                            <div className="tc">
                                ...
                                <p data-aos={"fade-down"} data-aos-duration={"1000"} className={'w-70-ns f4-ns mr-auto ml-auto '}>
                                ...
                                <div data-aos={"fade-up"} data-aos-duration={"1000"}className={'db custom-link w-60-ns f3-ns hoverLine mr-auto ml-auto mt5 ba pt3 pl3 pb3 b--red br3'}>
                    ...
                    <article className="w-50-ns w-70-m shadow-2 center br3 pa3 pa4-ns mv3">
                        <div className={'flex flex-wrap justify-center'}>
                            <div className="tc">
                                ...
                                <div data-aos={"fade-up"} data-aos-duration={"1000"} className={'db custom-link w-60-ns hoverLine f3-ns mr-auto ml-auto mt5 ba pt3 pl3 pb3 b--red br3'}>
